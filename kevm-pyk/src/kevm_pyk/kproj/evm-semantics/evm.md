...
```k
 ...
 // --------------------------------------------------------------------------------------------------
    ...
    rule opcode2String(PUSH(N))        => "PUSH(" +String Int2String(MInt2Unsigned(N)) +String ")"
    rule opcode2String(DUP(N))         => "DUP(" +String Int2String(MInt2Unsigned(N)) +String ")"
    rule opcode2String(SWAP(N))        => "SWAP(" +String Int2String(MInt2Unsigned(N)) +String ")"
    rule opcode2String(LOG(0p256))     => "LOG(0)"
    rule opcode2String(LOG(1p256))     => "LOG(1)"
    rule opcode2String(LOG(2p256))     => "LOG(2)"
    rule opcode2String(LOG(3p256))     => "LOG(3)"
    rule opcode2String(LOG(4p256))     => "LOG(4)"
